...
-- alter availability group MyAvailability Group modify replica on N'ThisReplica' with (secondary_role(read_only_routing_url=N'<url>'))
...
begin -- if server supports read-only routing
 ...
 exec xp_instance_regread N'HKEY_LOCAL_MACHINE',N'SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQLServer\SuperSocketNetLib\AdminConnection\Tcp', N'TcpDynamicPorts', @reg_value output
...
varchar(255))
 ...
 exec xp_instance_regread N'HKEY_LOCAL_MACHINE', N'SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQLServer\SuperSocketNetLib\Tcp', N'ListenOnAllIPs', @listen_all output
 ...
 exec xp_instance_regread N'HKEY_LOCAL_MACHINE', N'SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL15.MSSQLServer\SuperSocketNetLib\Tcp\IPAll', N'TcpDynamicPorts', @tcp_dynamic_ports output

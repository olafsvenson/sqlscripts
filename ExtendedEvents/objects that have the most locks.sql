/*
https://docs.microsoft.com/en-us/sql/relational-databases/extended-events/find-the-objects-that-have-the-most-locks-taken-on-them?view=sql-server-ver15
*/
...
SELECT @dbid = db_id('Pegasus2008MS');

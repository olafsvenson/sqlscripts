...
(SET filename = N'blocked_process.xel',
     metadatafile = N'blocked_process.xem',
     max_file_size=(65536),
...
EXEC sp_configure 'blocked process threshold', '5'; -- 0 чтобы отключить
RECONFIGURE
GO
...
GO
/* Enabled the blocked process report */
EXEC sp_configure 'blocked process threshold', '0'; -- 0 чтобы отключить
RECONFIGURE
GO
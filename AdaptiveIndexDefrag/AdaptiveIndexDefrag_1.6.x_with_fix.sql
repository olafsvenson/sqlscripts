/*
	...
	за основу взял 1.6.7 и добавил скрипт от AndrewG2 + незакоммиченные замечания от других пользователей
*/
...
BEGIN SET @hasIXsOUT = 1 END ELSE BEGIN SET @hasIXsOUT = 0 END'
		...
		DECLARE @ver VARCHAR(10)
				...
				, @rowmodctr bigint -- dbo.usp_AdaptiveIndexDefrag, incorrect definition for @rodmodctr variable #198 NUMERIC(10,3)-> bigint
				, @record_count bigint

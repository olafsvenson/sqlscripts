/*
USAGE:
1. Use Results To Grid option in SSMS.
2. Set the @SnapshotIntervalSeconds and @MaxIterationCount parameters. Optionally, edit the script to define the counters to be collected.
3. Run the script.
...
DECLARE @MaxIterationCount int = 10; -- The number of iterations. Use a large number for indefinite capture duration.
...
SELECT 'Buffer Node' AS object_name, 'Page life expectancy' AS counter_name, '000' AS instance_name, NULL AS base_counter_name UNION ALL

...
/****** Object:  StoredProcedure [dbo].[beta_lockinfo]    Script Date: 03.11.2021 11:40:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[beta_lockinfo] @allprocesses  tinyint = 0,
                              @textmode      bit     = 0,
...
DECLARE @procs TABLE (
   ...
   program_name     nvarchar(256) COLLATE Latin1_General_BIN2 NULL,
...
CREATE TABLE #output(
       ...
       appl        nvarchar(256)  COLLATE Latin1_General_BIN2 NULL,
...
BEGIN
   ...
   CREATE TABLE guest.beta_lockinfo(
	...
	ALTER INDEX [beta_lockinfo_pk] on [guest].[beta_lockinfo] rebuild with(data_compression = page)

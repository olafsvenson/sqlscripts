...
/****** Object:  Job [Monitoring]    Script Date: 26.10.2022 17:14:56 ******/
EXEC msdb.dbo.sp_delete_job @job_id=N'252bb5e2-f5e8-4ed0-b031-864848516f85', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 26.10.2022 17:14:56 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [dbsize]    Script Date: 26.10.2022 17:14:57 ******/
...
--select * from dbo.Monitoring_dbsize order by dt desc', 
		...
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [tablesize]    Script Date: 26.10.2022 17:14:57 ******/
...
DELETE FROM [master].[dbo].[Monitoring_tablesize] WHERE database_name IN (''master'',''model'',''msdb'',''tempdb'') and[dt]> cast(getdate() as date)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [waits]    Script Date: 26.10.2022 17:14:57 ******/

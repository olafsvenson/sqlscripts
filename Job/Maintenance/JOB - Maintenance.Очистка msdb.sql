...
IF EXISTS (SELECT job_id 
            ...
            WHERE name = N'Maintenance.Maintenance.Очистка msdb')
EXEC msdb.dbo.sp_delete_job @job_name=N'Maintenance.Очистка msdb', @delete_unused_schedule=1
GO

/****** Object:  Job [Maintenance.Очистка msdb]    Script Date: 25.08.2023 12:33:58 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 25.08.2023 12:33:58 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Maintenance.Очистка msdb', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [clear]    Script Date: 25.08.2023 12:33:58 ******/

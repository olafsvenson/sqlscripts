...
/****** Object:  Job [** Остановка регламентных заданий]    Script Date: 24.09.2021 10:41:43 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 24.09.2021 10:41:43 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Создание хранимки]    Script Date: 24.09.2021 10:41:43 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [** Обновление статистики]    Script Date: 24.09.2021 10:41:43 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [05.2. Обслуживание индексов. Реиндексация (КД ??)]    Script Date: 24.09.2021 10:41:43 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'05.2. Обслуживание индексов. Реиндексация (КД ??)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [05.2. Обслуживание индексов. Реиндексация (КД 0242-2314 15мин)]    Script Date: 24.09.2021 10:41:43 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Обновление статистики - поток1]    Script Date: 24.09.2021 10:41:43 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Обновление статистики - поток1', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Обновление статистики - поток2]    Script Date: 24.09.2021 10:41:44 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Обновление статистики - поток2', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Обновление статистики - поток3]    Script Date: 24.09.2021 10:41:44 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Обновление статистики - поток3', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Обновление статистики - поток4]    Script Date: 24.09.2021 10:41:44 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Обновление статистики - поток4', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Обновление статистики - поток5]    Script Date: 24.09.2021 10:41:44 ******/

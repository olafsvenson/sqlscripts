...
/****** Object:  Job [Start Full Hourly SQL Trace]    Script Date: 01/30/2012 15:25:12 ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 01/30/2012 15:25:12 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Start Full Hourly SQL Trace', 
		...
		@job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [start_trace]    Script Date: 01/30/2012 15:25:14 ******/
...
SET @folder = N''F:\SQL_Traces\'' + @@SERVICENAME + N''\''

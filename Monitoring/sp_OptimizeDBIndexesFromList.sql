...
/****** Object:  StoredProcedure [dbo].[sp_OptimizeDBIndexesFromList]    Script Date: 23.09.2015 10:00:18 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_OptimizeDBIndexesFromList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_OptimizeDBIndexesFromList]
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_OptimizeDBIndexesFromList]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'
CREATE PROCEDURE [dbo].[sp_OptimizeDBIndexesFromList]
AS
begin
set nocount on
